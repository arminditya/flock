...
class AturProfilPribadi extends CI_Controller
{
    ...
    public function _aturpengambilan()
    {
		...
		//tambahan
		// 5. Get kode unik padok
        $getKodeUnikPadok = $this->SipadokTransaction_Model->getKodeUnikPengambilan($KdDataPadok);
        $ValueKodeUnikPadok = '';
        foreach ($getKodeUnikPadok as $dt)
        {
            $ValueKodeUnikPadok = $dt->KodeUnikPengambilan;
        }
		...
		//tambahan		
		$subject = 'Informasi Pengambilan PADOK';					
		$message = "
			Dear SIPADOK user, <br><br>
			Berikut adalah informasi pengambilan PADOK anda : <br>
			<html><body>
			<table rules=all style=border-color: #666 cellpadding=10>
			<tr><td><strong>Kode Transaksi :</strong> </td><td>".$this->kdtransaksipadok."</td></tr>
			...
			<tr><td><strong>Waktu Pengambilan:</strong> </td><td>   ".$PengambilanReqTgl." ".$PengambilanReqTime."  </td></tr>
			</table>
			</body></html>
			<br>
			Silahkan melakukan konfirmasi penerimaan paket / dokumen anda pada menu <strong>Padok Saya</strong> di aplikasi SIPADOK Tokopedia.<br><br>
			regards, <br><br>
			SIPADOK Tokopedia
		";
		//$to = 'majestyeksa@gmail.com';
		$to = $emailKantor;
