...
<div class="login-box">
  ...
  <div class="login-box-body">
    <p class="login-box-msg">Looks like you still use your default password</p>
    <p class="login-box-msg"> To prevent unauthorized access to your information, please choose a new password before signing in to your account</p>
    <p  class="text-red" <?php echo validation_errors();?>> </p>
    <form action="<?php echo $this->config->base_url();?>index.php/verifyLogin/change_password" method="post">
      ...
      <div class="form-group has-feedback">
       ...
       <div class="form-group has-feedback">
        <input type="password" name="renew_password" class="form-control" placeholder="Retype New Password">
        <span class="glyphicon glyphicon-lock form-control-feedback"></span>
       </div>
