...
<div class="container col-md-8">
          <div class="box" >
            ...
            <div class="box-body"  style="overflow-x:auto;">
                ...
                <div style='display:none;' id='divKeluar' name='divKeluar'>
                    <table id="tblKeluar" class="table table-bordered" role="grid">
                        <tr>
                            <td width="35%">Nama Peserta / Karyawan</td>
                            <td width="3%">: </td>
                            <!-- <td width="62%"><input type="text" name="KeluarNamaPeserta" class="form-control" placeholder="Nama Peserta"/></td> -->
                            <td width="62%">
                                <select name="NaikturunNamaPeserta" id="NaikturunNamaPeserta" class="form-control">
                                                <option value=''>Pilih NIP - Nama Peserta / Karyawan</option>
                                                  <?php 
                                                  foreach($peserta as $p){
                                                      $selected = "";
                                                    // echo "<option $selected value=" . $p->KdPeserta . ">" . $p->NmPeserta . " - " . $p->NIP. "</option>";
                                                    echo "<option $selected value=" . $p->KdPeserta . ">" . $p->NIP. " - " . $p->NmPeserta . "</option>";
                                                  }	
                                                ?>		
                                  </select>
                            </td>
