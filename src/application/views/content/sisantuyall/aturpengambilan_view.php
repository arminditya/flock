...
<div class="container col-md-8">
          <div class="box" >
            <div class="box-header">
              <h4>Validasi Pengambilan Paket / Dokumen</h4>
            </div>

            <div class="box-body"  style="overflow-x:auto;">
                <form id="requestpengambilan" name="requestpengambilan" method="post" action="<?php echo base_url().'index.php/SipadokOA/AturPengambilan/do_save_action' ?>">
                    ...
                    <input type="hidden" name="PengambilanStatus" value="2"> 
                    <input type="hidden" name="BktTerimaStatus" value="1"> 
                    <div id='divKeluar' name='divKeluar'>
                        ...
                        <table id="validasipengambilan" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                          <tr>
                            <td width="35%">Rencana Pengambilan Paket / Dokumen</td>
                            <td width="3%"> : </td>
                            <td width="62%"><?php echo $PengambilanReqTgl ?> <?php echo $PengambilanReqTime ?></td>
                          </tr>


                          <tr>
                            <td width="35%">Kode Unik Pengambilan</td>
                            <td width="3%"> : </td>
                            <td width="62%"><input type="text" name="KodePengambilan" class="form-control" placeholder="Kode Unik Pengambilan"/></td>
                          </tr>
                        </table>
                        ...
                        <table id="table-button" class="table" role="">
                          <tr>
                            ...
                            <td></td>
                            <td>
                              <button id="btnsubmit" type="submit" class="btn btn-primary" style="float: right;">PAKET / DOKUMEN TELAH DISERAHKAN</button>
                            </td>
                          </tr>
                        </table>
